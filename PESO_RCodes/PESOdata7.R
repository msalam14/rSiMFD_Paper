...
QEfun<-as.matrix(read.csv("QEfun7.csv"))
QLfun<-as.matrix(read.csv("QLfun7.csv"))
...
write.table(par_res,file=paste(dirP,"peso_dat_res7_",ifelse(c_opt,1,2),".txt",sep=""),col.names = FALSE,row.names = FALSE)
