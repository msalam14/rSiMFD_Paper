...
QEfun<-as.matrix(read.csv("QEfun16.csv"))
QLfun<-as.matrix(read.csv("QLfun16.csv"))
...
write.table(par_res,file=paste(dirP,"peso_dat_res16_",ifelse(c_opt,1,2),".txt",sep=""),col.names = FALSE,row.names = FALSE)
